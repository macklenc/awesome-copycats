...
run_once("cinnamon-settings-daemon")
run_once("btsync")
run_once("synapse")
-- }}}
...
modkey     = "Mod4"
altkey     = "Mod1"
terminal   = "gnome-terminal.wrapper" --"urxvtc" or "xterm"
editor     = "vim" or os.getenv("EDITOR") or "nano"
editor_cmd = "subl" --  terminal .. " -e " .. editor
...
musicplr   = terminal .. " -g 130x34-320+16 -e cmus " ---ncmpcpp
volumesett = terminal .. " -g 130x34-320+16 -e alsamixer"
...
--{{{ Tag Wallpapers
        for s = 1, screen.count() do
          ...
          tags[s][t]:connect_signal("property::selected", function (tag)
           ...
           theme.wallpaper = "/home/timothy/Pictures/wallpaper/wallpaper" .. t .. ".png"
...
--             if not tag.selected then return end
--             wallpaper_cmd = "awsetbg /home/timothy/Pictures/wallpaper/wallpaper" .. t .. ".png"
...
volicon:buttons(awful.util.table.join(awful.button({ }, 1, function () awful.util.spawn_with_shell(volumesett) end)))
...
volumewidget:buttons(awful.util.table.join(awful.button({ }, 1, function () awful.util.spawn_with_shell(volumesett) end)))
